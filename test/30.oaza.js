...
describe(FILENAME, () => {
    it('Oaza.byZipcode("0970000")', () => {
        const oaza = jp_zipcode_lookup_1.Oaza.byZipcode("0970000").pop();
    ...
    it('Oaza.byZipcode("1040061")', () => {
        const oaza = jp_zipcode_lookup_1.Oaza.byZipcode("1040061").pop();
    ...
    it('Oaza.byZipcode("1006640")', () => {
        const oaza = jp_zipcode_lookup_1.Oaza.byZipcode("1006640").pop();
    ...
    it('Oaza.byZipcode("9071800")', () => {
        const oaza = jp_zipcode_lookup_1.Oaza.byZipcode("9071800").pop();
